...
public class ModMenuTypes {
    ...
    public static final RegistryObject<MenuType<FlamingFlouriteFurnaceMenu>> FLAMING_FLOURITE_FURNACE_MENU
            = registerMenuType(FlamingFlouriteFurnaceMenu::new, "flaming_flourite_furnace_menu");
