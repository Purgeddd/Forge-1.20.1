...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    FLAMING_FLOURITE("flaming_flourite", 30, new int[]{ 7, 9, 7, 6 }, 30,
            SoundEvents.ARMOR_EQUIP_DIAMOND, 5f, 0.15f, () -> Ingredient.of(ModItems.FLAMING_FLOURITE.get())),

    CORRUPTED("corrupted", 30, new int[]{ 9, 11, 9, 8 }, 35,
            SoundEvents.ARMOR_EQUIP_CHAIN, 5f, 0.2f, () -> Ingredient.of(ModItems.CORRUPTED_CORE.get()));
