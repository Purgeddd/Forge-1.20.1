...
public class FlamingFlouriteFurnaceRecipe extends AbstractCookingRecipe {
    public FlamingFlouriteFurnaceRecipe(ResourceLocation pId, String pGroup,
    ...
    public ItemStack getToastSymbol() {
        return new ItemStack(ModBlocks.FLAMING_FLOURITE_FURNACE_BLOCK.get());
    }
    ...
    public static class Type implements RecipeType<FlamingFlouriteFurnaceRecipe> {
        public static final Type INSTANCE = new Type();
    }

    public static class Serializer implements RecipeSerializer<FlamingFlouriteFurnaceRecipe> {
        private final int defaultCookingTime;
        public static final FlamingFlouriteFurnaceRecipe.Serializer INSTANCE = new Serializer(50);

        public Serializer(int defaultCookingTime) {
            this.defaultCookingTime = defaultCookingTime;
        }

        public FlamingFlouriteFurnaceRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
            ...
            return new FlamingFlouriteFurnaceRecipe(pRecipeId, s, cookingbookcategory, ingredient, itemstack, f, i);
        }

        public FlamingFlouriteFurnaceRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        public void toNetwork(FriendlyByteBuf pBuffer, FlamingFlouriteFurnaceRecipe pRecipe) {
