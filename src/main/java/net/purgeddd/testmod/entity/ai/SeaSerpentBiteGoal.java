...
public class SeaSerpentBiteGoal extends Goal {
    protected final SeaSerpentEntity mob;
    private final double speedModifier;
    private final boolean followingTargetEvenIfNotSeen;
    private int ticksUntilNextAttack;
    private final int attackInterval = 30;  // Total ticks for the attack cycle

    public SeaSerpentBiteGoal(SeaSerpentEntity mob, double speedModifier, boolean followingTargetEvenIfNotSeen) {
        this.mob = mob;
    ...
    public boolean canUse() {
        ...
        return target != null && target.isAlive() && this.mob.distanceToSqr(target) <= this.getAttackReachSqr(target);
    }
    ...
    public void tick() {
        ...
        if (target != null) {
            ...
            if (distanceSq <= this.getAttackReachSqr(target)) {
                ...
                if (this.ticksUntilNextAttack == 4) {
